...
//	Distribution3D* positionDistrubtion5 = new DistributionCircle({ 0,0,0 }, 2);
...
//	ParticleDistributionSimple particleDistribution5(densityDistribution, positionDistrubtion5, velocityDistrubtion5, angularVelocityDistrubtion);
//	SimulationInput* input = new SimulationInputRandomSimple({ particleQuadrantCount, particleQuadrantCount, particleQuadrantCount, particleQuadrantCount, particleQuadrantCount },
